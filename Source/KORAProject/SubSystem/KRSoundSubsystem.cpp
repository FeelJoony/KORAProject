...
void UKRSoundSubsystem::CategoryTagMapping()
{
	...
	//FinalBoss
	WorldEventToBGMCategoryMap.Add(KRTAG_WORLDEVENT_FINALBOSS_PHASE1, KRTAG_SOUND_CATEGORY_BGM_FINALBOSS_PHASE1);
	WorldEventToBGMCategoryMap.Add(KRTAG_WORLDEVENT_FINALBOSS_PHASE2, KRTAG_SOUND_CATEGORY_BGM_FINALBOSS_PHASE2);
	WorldEventToBGMCategoryMap.Add(KRTAG_WORLDEVENT_FINALBOSS_PHASE3, KRTAG_SOUND_CATEGORY_BGM_FINALBOSS_PHASE3);
}
