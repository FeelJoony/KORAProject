...
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_MAINMENU, "WorldEvent.MainMenu");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_DIRECTIONROOM, "WorldEvent.DirectionRoom");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_BARION, "WorldEvent.Barion");;
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_FORGOTTEN_DOWNTOWN, "WorldEvent.Forgotten.DownTown");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_FORGOTTEN_BEACH, "WorldEvent.Forgotten.Beach");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_SEMIBOSS, "WorldEvent.SemiBoss");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_FINALBOSS_PHASE1, "WorldEvent.FinalBoss.Phase1");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_FINALBOSS_PHASE2, "WorldEvent.FinalBoss.Phase2");
UE_DEFINE_GAMEPLAY_TAG(KRTAG_WORLDEVENT_FINALBOSS_PHASE3, "WorldEvent.FinalBoss.Phase3");
