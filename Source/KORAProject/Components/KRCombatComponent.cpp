...
void UKRCombatComponent::SetCurrentWeapon(UKRWeaponInstance* InInstance, AKRWeaponBase* InActor)
{
    CurrentWeaponInstance = InInstance;
    CurrentWeaponActor    = InActor;
}

AKRWeaponBase* UKRCombatComponent::GetCharacterCarriedWeaponByTag(FGameplayTag InWeaponTagToGet) const
{
...
AKRWeaponBase* UKRCombatComponent::GetCharacterCurrentEquippedWeapon() const
{
...
AKRWeaponBase* UKRCombatComponent::GetWeaponBySlot(EWeaponSlot InSlot) const
{
...
void UKRCombatComponent::OnWeaponPulledFromTargetActor(AActor* InteractedActor, const FHitResult& HitResult)
{
