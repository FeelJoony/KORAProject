...
void AKRHeroCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	KRInputComponent->BindNativeInputAction(InputConfigDataAsset, KRGameplayTags::KRTag_Input_Move, ETriggerEvent::Triggered, this, &ThisClass::Input_Move);
	KRInputComponent->BindNativeInputAction(InputConfigDataAsset, KRGameplayTags::KRTag_Input_Look, ETriggerEvent::Triggered, this, &ThisClass::Input_Look);
